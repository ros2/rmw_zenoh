...
void rmw_zenoh_common_cpp::log_debug_qos_profile(const rmw_qos_profile_t * qos_profile)
{
  ...
  RCUTILS_LOG_DEBUG_NAMED("rmw_zenoh_common_cpp", "    reliability: %s", reliability_string);
  RCUTILS_LOG_DEBUG_NAMED("rmw_zenoh_common_cpp", "    history: %s", history_string);
  RCUTILS_LOG_DEBUG_NAMED("rmw_zenoh_common_cpp", "    depth: %zu", qos_profile->depth);
  RCUTILS_LOG_DEBUG_NAMED("rmw_zenoh_common_cpp", "    durability: %s", durability_string);
  ...
  RCUTILS_LOG_DEBUG_NAMED("rmw_zenoh_common_cpp", "    liveliness: %s", liveliness_string);
  RCUTILS_LOG_DEBUG_NAMED(
    "rmw_zenoh_common_cpp",
